import { Accordion, AccordionDetails, AccordionSummary, Box, Container, FormControl, InputLabel, MenuItem, OutlinedInput, Paper, Select, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from '@mui/material'
        ...
        <Table size = "small" >
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell > <EditIcon cursor="pointer"></EditIcon> </TableCell>
            </TableRow>
            <TableRow>
              <TableCell contentEditable="true">University of Gujrat</TableCell>
